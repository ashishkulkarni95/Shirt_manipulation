...
#ifndef GRASPING_ROBOT2_STATE_NODE_HPP
#define GRASPING_ROBOT2_STATE_NODE_HPP
...
public:
    ...
    robot_comm::RobotComm* rc_g2;

    GraspingRob2State(std::string ip_val, int port_val);
